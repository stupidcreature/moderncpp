...
int main()
{
    ...
    double* resvalues = 0;
    size_t  ressize   = new_stat.GetLastValuesForIndexAsCopy(0, 100, resvalues);

    values.clear();
    CStatisticsStorage::TDateTime times[3];

    size_t count = new_stat.GetLastTimestamps(3, &times[0]);
